...
Route::middleware('auth')->group(function() {
    ...
    Route::resource('transaction', \App\Http\Controllers\TransactionController::class)->names('transaction');
    ...
    Route::prefix('transaction')->group(function() {
        ...
        //Route::post('/{transaction}/destroy', [\App\Http\Controllers\TransactionController::class, 'destroy'])->name('transaction.destroy');
    });
