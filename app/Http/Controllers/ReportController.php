...
class ReportController extends Controller
{
    ...
    public function stockMinimum(Request $request) {
        ...
        $dataTable = $this->htmlBuilder
            ...
            ->addColumn(['data' => 'stock', 'name' => 'stock', 'title' => 'Sisa Stok', 'searchable' => false])
            ->addColumn(['data' => 'satuan', 'name' => 'satuan', 'title' => 'Satuan', 'searchable' => false]);
    ...
    public function topCustomer(Request $request) {
        ...
        $dataTable = $this->htmlBuilder
            ...
            ->addColumn(['data' => 'DT_RowIndex', 'name' => 'DT_RowIndex', 'title' => 'No', 'orderable' => false, 'searchable' => false, 'width' => 30])
            ->addColumn(['data' => 'customer_id', 'name' => 'customer_id', 'title' => 'Nama'])
            ->addColumn(['data' => 'trx_number', 'name' => 'trx_number', 'title' => 'Nomor Transaksi'])
           
            ->addColumn(['data' => 'total', 'name' => 'stock', 'title' => 'Total ATK', 'searchable' => false, 'orderable' => false, ]);
